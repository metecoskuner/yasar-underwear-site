  ...
  return (
    <form onSubmit={onSubmit} className="max-w-3xl w-full bg-white p-6 rounded-2xl shadow-lg">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.companyName')}</label>
        ...
        <div>
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.country')}</label>
        ...
        <div>
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.website')}</label>
          <input value={form.website} onChange={(e) => onChange('website', e.target.value)} className="mt-1 block w-full border rounded-lg px-3 py-2 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)] focus:border-transparent" />
        </div>

        <div>
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.businessType')}</label>
          <input value={form.businessType} onChange={(e) => onChange('businessType', e.target.value)} className="mt-1 block w-full border rounded-lg px-3 py-2 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)] focus:border-transparent" />
        </div>

        <div>
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.interestedProducts')}</label>
          <input value={form.interestedIn} onChange={(e) => onChange('interestedIn', e.target.value)} className="mt-1 block w-full border rounded-lg px-3 py-2 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)] focus:border-transparent" />
        </div>

        <div>
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.estimatedFirstOrder')}</label>
          <input value={form.estimatedFirstOrder} onChange={(e) => onChange('estimatedFirstOrder', e.target.value)} className="mt-1 block w-full border rounded-lg px-3 py-2 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)] focus:border-transparent" />
        </div>

        <div>
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.annualVolume')}</label>
          <input value={form.annualVolume} onChange={(e) => onChange('annualVolume', e.target.value)} className="mt-1 block w-full border rounded-lg px-3 py-2 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)] focus:border-transparent" />
        </div>

        <div>
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.contactPerson')}</label>
        ...
        <div>
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.email')}</label>
        ...
        <div className="sm:col-span-2">
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.phone')}</label>
        ...
        <div className="sm:col-span-2">
          <label className="text-sm font-medium">{t('pages.wholesale.form.labels.message')}</label>
