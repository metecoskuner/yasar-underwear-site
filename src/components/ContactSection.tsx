          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-black">
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                <h2 className="text-3xl sm:text-4xl font-extrabold">İletişime Geç</h2>
                <p className="text-slate-600 mt-2 max-w-full leading-relaxed">
                  Sorularınız, iş birlikleri veya toptan talepler için bize yazabilirsiniz. Ortalama dönüş süresi
                  <span className="font-semibold"> 24 saat</span>.
                </p>
              </div>
              <div className="hidden md:flex items-center">
                <span className="inline-flex items-center rounded-full bg-slate-50 px-3 py-1 text-xs font-medium text-slate-700 border border-slate-200">Yanıt: ~24s</span>
              </div>
            </div>
            <div className="mt-6">
              <div className="bg-slate-50 border border-black rounded-lg overflow-hidden">
                ...
                <div className="border-t border-slate-200 flex items-center gap-3 px-4 py-3">
                  ...
                  <div>
                    <div className="text-xs text-slate-500">Saatler</div>
                    <div className="text-slate-800 font-medium">Hafta içi 09:00 – 18:00</div>
                  </div>
                </div>
              </div>

              <div className="mt-6 flex flex-wrap gap-3">
                <a href="mailto:info@yasarunderwear.example" className="inline-flex items-center gap-2 rounded-md bg-white border border-slate-200 px-3 py-2 text-sm text-slate-700 hover:bg-slate-50">E-posta Gönder</a>
                <a href="tel:+905551234567" className="inline-flex items-center gap-2 rounded-md bg-black text-white px-3 py-2 text-sm font-medium hover:bg-neutral-800">Bizi Ara</a>
              </div>
            </div>
          </div>
        </div>
